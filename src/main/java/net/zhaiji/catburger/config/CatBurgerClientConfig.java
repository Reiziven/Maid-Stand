...
public class CatBurgerClientConfig {
    ...
    private static final ForgeConfigSpec.ConfigValue<String> QUICK_SELECT_STYLE = BUILDER
            .comment("Visual style of the Quick-Select overlay. Options: CIRNO (ice-blue), HAKUREI (shrine-maiden red/gold), WHEEL (transparent radial wheel).")
            .define("quickSelectStyle", "CIRNO");
